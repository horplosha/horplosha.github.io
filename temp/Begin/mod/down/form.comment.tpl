...
<form action="index.php?dn=down" method="post" onsubmit="return COMMENT.submit(this,'down');" name="comform" id="comform" />
<div class="cont">
  <div class="conttext">
  <div class="conttext ac">
    <div class="al" id="errorbox"></div>
    <div class="sitenotice al" id="sendbox" style="display:none">
      <img src="temp/Begin/images/progress.gif" class="fl" alt="" /> <strong>Идёт отправка комментария ... </strong>
    </div>
  </div>
  <div class="form">
    <table class="ac">
      ...
      <tr>
        <td>
          ...
          <div>
           <p><b>*</b> {comment_title}:</p>
           <input name="comtitle" id="comtitle" style="width:96%" type="text" maxlength="255" value="{title}" disabled="disabled" />
          </div>
          <div>
            <p><b>*</b> Сообщение:</p>
