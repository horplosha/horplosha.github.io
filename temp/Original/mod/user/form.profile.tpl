      ...
      <tbody>
        <tr>
          ...
          <fieldset>
            ...
            <img src="temp/Original/images/qicon.gif" alt="{icq_hint}" align="absmiddle">
          </fieldset>
          </td>
        </tr>
        <tr>
          ...
          <fieldset>
            ...
            <img src="temp/Original/images/qicon.gif" alt="{msn_hint}" align="absmiddle">
          </fieldset>
          </td>
        </tr>
        <tr>
          ...
          <fieldset>
            ...
            <img src="temp/Original/images/qicon.gif" alt="{www_hint}" align="absmiddle">
          </fieldset>
          <br />
          </td>
        </tr>
      ...
      <tbody>
        <tr>
          ...
          <fieldset>
            ...
            <img src="temp/Original/images/qicon.gif" alt="{pass_hint}" align="absmiddle">
          </fieldset>
          </td>
        </tr>
        <tr>
      ...
      <tbody>
        <tr>
          ...
          <fieldset>
            ...
            <img src="temp/Original/images/qicon.gif" alt="{mail_hint}" align="absmiddle">
          </fieldset>
          </td>
        </tr>
        <tr>
